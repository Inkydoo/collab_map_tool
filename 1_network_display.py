...
type_dict = {"Infrastructure": ["#ffcc00", "icons/physical.png"],
             ...
             "Ecological": ["#006d5b", "icons/eco.png"],
        ...
        config = ag.Config(width=1200,
                           ...
                           physics={
                               "barnesHut": {
                                   ...
                                   "centralGravity": 0.01,  # pulls all nodes toward the center
                                   "springLength": 500,  # rest length of edges
                                   "springConstant": 0.9,  # stiffness of edges (higher = stronger pull along edges)
                                   "damping": 0.09,
                                   "avoidOverlap": 1
                               }
                           },
